...
public class R42SwitchStatement {
    /*
    Write a program using the switch statement
Let us consider there are three students in the class with
roll number  starting from (101 to 103) if any number other
than 101-103 are present display "Not found Student name: in Class"
...
Other than this roll number  it should print "Not found Student name: in Class"
    ...
    public static void main(String[] args) {
        ...
        int rollNumber = newScanner.nextInt();
